...
export const PLANT_DEFS: readonly PlantDef[] = [
  ...
  { id: 'piercer',    name: '穿透射手', comboSegment: 4, attackPower: 30, hp: 100, element: 'ice',    trajectory: 'pierce' },
  { id: 'sprayer',    name: '大喷菇',   comboSegment: 4, attackPower: 25, hp: 100, element: 'fire',   trajectory: 'area' },
  { id: 'tracker',    name: '猫尾草',   comboSegment: 4, attackPower: 25, hp: 100, element: 'normal', trajectory: 'tracking' },
]
